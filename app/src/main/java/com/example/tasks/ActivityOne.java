...
//        toast.show();
        if (InternetConnection.checkConnection(getApplicationContext())) {
            ...
            Toast.makeText( ActivityOne.this,"Connection not available" ,Toast.LENGTH_SHORT).show();
        }
    ...
    class GetDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(ActivityOne.this);
...
//                                String saturday= innerObject.getString(Keys.KEY_SATURDAY);
                                ...
                                if(dayOfTheWeek.matches(Day)) {
//                                    int pos=1;
//                                    JSONArray arr = new JSONArray("Sheet1");
//                                    JSONObject jObj = arr.getJSONObject(1);
//                                    String date = jObj.getString("Menu");
                                    //model.setMenu(Menu);
                                    model.setMenu(Menu);
                                    model.setDay(Day);

                                }
                                //anu.setText(dayOfTheWeek);
